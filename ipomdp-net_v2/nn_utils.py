...
def scale_change_nd2lin(nd_tensor, fc_params, names=None):
    """

    :param nd_tensor:
    :param fc_params:
    :param names:
    :return: output (linear tensor computed through fc layer(s))
    """
...
def scale_change_lin2nd(lin_tensor, output_shape, fc_params, names=None):
    """
